...
batch_size = 32
num_workers = 4
csv_test=f'../data/vip/vaynen_test_vip_new.csv' 
csv_train=f'../data/vip/vaynen_train_vip_new.csv'
...
train_model(model,train_loader=train_dataloader,epochs=20,features_set= 'vip' )
result=evaluate_model(model,test_dataloader)

with open("results.txt", "a") as f:
    f.write(f"{result}\n")

torch.save(model, f'model_vip_old.pth')
